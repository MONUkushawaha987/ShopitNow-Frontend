...
const Home = () => {
  ...
  return (
    <div className="flex flex-col  items-center ">
      <p className="text-7xl font-bold text-center mt-10 ml-14 absolute text-white  ">
        Welcome to Our ShopitNow
      </p>

      <p className="text-3xl  text-center mt-[150px] ml-14 absolute text-white ">
        ...
        <Link to="/products" className="font-bold border-none px-6 py-3 mt-[100px] text-white rounded-full bg-yellow-500 text-[27px] inline-block">
          Shop Now
        </Link>
      </p>
      ...
      <div className="text-black  h-[140vh] w-screen bg-teal-100">
        <p className="text-5xl font-bold text-center mt-[80px]">
      ...
      <div className="text-black  h-[130vh] w-screen bg-gray-300">
        <p className="text-5xl font-bold text-center mt-[80px] text-yellow-500">
          Why Choose ShopitNow?
        </p>
        <div className="grid grid-rows-1 md:grid-rows-2 lg:grid-rows-3 gap-4 h-[80vh] mx-10 mt-[60px]">
      ...
      <div className="text-black  h-[180vh] w-screen bg-blue-400">
        <WhatCustomersSay />
      </div>
